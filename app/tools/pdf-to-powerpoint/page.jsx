...
import { Presentation, Upload, Download, FileText, Zap } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Turn your PDF files into easy to edit PPT and PPTX slideshows. Each page becomes an editable slide.
          </p>
        </div>
          ...
          {!file && (
            ...
            >
              ...
              <p className="text-gray-600 mb-4">
                Upload a PDF file to convert it to PowerPoint format
              </p>
            ...
            <div className="bg-orange-50 border border-orange-200 rounded-xl p-6">
              <div className="text-center mb-6">
                ...
                <p className="text-orange-700 mb-4">
                  Your PDF has been converted to PowerPoint format and is ready for download.
                </p>
              </div>
              ...
              <div className="bg-white rounded-lg p-6 mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-sm text-gray-600">PowerPoint File Size</div>
                  </div>
                  
                  <div className="text-center">
                    <div className="text-2xl font-bold text-blue-600 mb-1">
                      {conversionResult.slidesCreated}
                    </div>
